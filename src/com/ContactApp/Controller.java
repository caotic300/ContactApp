...
import com.ContactApp.datamodel.Contact;
import com.ContactApp.datamodel.ContactData;
...
public class Controller {
    ...
    public void deleteContact() {
        ...
        if (selectedContact == null) {
            ...
            Optional<ButtonType> reult = alert.showAndWait();
            if (reult.isPresent() && reult.get() == ButtonType.OK) {
